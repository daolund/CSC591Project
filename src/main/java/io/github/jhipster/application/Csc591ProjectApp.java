...
public class Csc591ProjectApp {

    private static final Logger log = LoggerFactory.getLogger(Csc591ProjectApp.class);

    private final Environment env;

    public Csc591ProjectApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes CSC591Project.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Csc591ProjectApp.class);
